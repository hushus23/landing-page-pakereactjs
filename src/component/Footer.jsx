        ...
        <div className="row justify-content-between copyright">
          ...
          <div className="col-6 col-sm-3 text-right">
            <ul className="social-footer2">
              <li className=""><a title="instagram" target="_blank" href="..."><img alt="facebook" width="30" height="30" src="src\assets\images\facebook logo.png"/></a></li>
              <li className=""><a href="" target="_blank" title="Facebook"><img alt="instagram" width="30" height="30" src="src\assets\images\instagram logo.png"/></a></li>
              <li className=""><a href="" target="_blank" title="Linkedin"><img alt="linkedin" width="30" height="30" src="src\assets\images\linkedin logo.png"/></a></li>
            </ul>  
          </div>
          </div>
      </div>
